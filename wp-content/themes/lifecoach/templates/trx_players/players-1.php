...
if ( !function_exists( 'lifecoach_template_players_1_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_players_1_theme_setup', 1 );
	function lifecoach_template_players_1_theme_setup() { 
		lifecoach_add_template(array(
			'layout' => 'players-1',
			'template' => 'players-1',
			'mode'   => 'players',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Players /Style 1/', 'lifecoach'),
...
// Template output
if ( !function_exists( 'lifecoach_template_players_1_output' ) ) {
	function lifecoach_template_players_1_output($post_options, $post_data) { 
		$show_title = true;
