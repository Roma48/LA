...
if ( !function_exists( 'lifecoach_template_matches_2_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_matches_2_theme_setup', 1 );
	function lifecoach_template_matches_2_theme_setup() {
		lifecoach_add_template(array(
			'layout' => 'matches-2',
			'template' => 'matches-2',
			'mode'   => 'matches',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Matches /Style 2/', 'lifecoach'),
...
// Template output
if ( !function_exists( 'lifecoach_template_matches_2_output' ) ) {
	function lifecoach_template_matches_2_output($post_options, $post_data) {
		$show_title = true;
