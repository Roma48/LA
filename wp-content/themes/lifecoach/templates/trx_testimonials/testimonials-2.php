...
if ( !function_exists( 'lifecoach_template_testimonials_2_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_testimonials_2_theme_setup', 1 );
	function lifecoach_template_testimonials_2_theme_setup() {
		lifecoach_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'lifecoach')
		));
	}
}

// Template output
if ( !function_exists( 'lifecoach_template_testimonials_2_output' ) ) {
	function lifecoach_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
