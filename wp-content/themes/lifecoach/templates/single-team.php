...
if ( !function_exists( 'lifecoach_template_single_team_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_single_team_theme_setup', 1 );
	function lifecoach_template_single_team_theme_setup() {
		lifecoach_add_template(array(
			'layout' => 'single-team',
			'mode'   => 'team',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single Team member', 'lifecoach'),
...
// Template output
if ( !function_exists( 'lifecoach_template_single_team_output' ) ) {
	function lifecoach_template_single_team_output($post_options, $post_data) {
