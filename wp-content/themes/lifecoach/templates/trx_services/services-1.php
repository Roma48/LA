...
if ( !function_exists( 'lifecoach_template_services_1_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_services_1_theme_setup', 1 );
	function lifecoach_template_services_1_theme_setup() {
		lifecoach_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'lifecoach'),
...
// Template output
if ( !function_exists( 'lifecoach_template_services_1_output' ) ) {
	function lifecoach_template_services_1_output($post_options, $post_data) {
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				if ($post_data['post_icon'] && $post_options['tag_type']=='icons') {
					$html = lifecoach_do_shortcode('[trx_icon icon="'.esc_attr($post_data['post_icon']).'" shape="round"]');
