...
if ( !function_exists( 'lifecoach_template_related_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_related_theme_setup', 1 );
	function lifecoach_template_related_theme_setup() {
		lifecoach_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'lifecoach'),
		...
		lifecoach_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'lifecoach'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'lifecoach'),
			'w'		 => 370,
			'h'		 => 370
		));
		lifecoach_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'lifecoach'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'lifecoach'),
			'w'		 => 370,
			'h'		 => 370
		));
		lifecoach_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'lifecoach'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'lifecoach'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'lifecoach_template_related_output' ) ) {
	function lifecoach_template_related_output($post_options, $post_data) {
