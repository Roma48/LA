...
if ( !function_exists( 'lifecoach_template_news_portfolio_theme_setup' ) ) {
	add_action( 'lifecoach_action_before_init_theme', 'lifecoach_template_news_portfolio_theme_setup', 1 );
	function lifecoach_template_news_portfolio_theme_setup() {
		lifecoach_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'lifecoach'),
...
// Template output
if ( !function_exists( 'lifecoach_template_news_portfolio_output' ) ) {
	function lifecoach_template_news_portfolio_output($post_options, $post_data) {
