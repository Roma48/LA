...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by LifeCoach
	 * @var $inverse	- added by LifeCoach
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by LifeCoach:
	// Color scheme
	if ($scheme && !lifecoach_param_is_off($scheme) && !lifecoach_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !lifecoach_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add LifeCoach color scheme in the row
	if ($scheme && !lifecoach_param_is_off($scheme) && !lifecoach_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
