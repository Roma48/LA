...
// Shortcode template
if ( ! class_exists( 'LIFECOACH_VC_ShortCode' ) ) {
	abstract class LIFECOACH_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeSingle' ) ) {
	abstract class LIFECOACH_VC_ShortCodeSingle extends LIFECOACH_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeAlone' ) ) {
	abstract class LIFECOACH_VC_ShortCodeAlone extends LIFECOACH_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeContainer' ) ) {
	abstract class LIFECOACH_VC_ShortCodeContainer extends LIFECOACH_VC_ShortCode {
...
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeCollection' ) ) {
	abstract class LIFECOACH_VC_ShortCodeCollection extends LIFECOACH_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeItem' ) ) {
	abstract class LIFECOACH_VC_ShortCodeItem extends LIFECOACH_VC_ShortCode {
...
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeColumns' ) ) {
	abstract class LIFECOACH_VC_ShortCodeColumns extends LIFECOACH_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('LIFECOACH_VC_ShortCodeAccordion') ) {
	abstract class LIFECOACH_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class LIFECOACH_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('LIFECOACH_VC_ShortCodeToggles') ) {
	abstract class LIFECOACH_VC_ShortCodeToggles extends LIFECOACH_VC_ShortCodeAccordion {}
	abstract class LIFECOACH_VC_ShortCodeTogglesItem extends LIFECOACH_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'LIFECOACH_VC_ShortCodeTabs' ) ) {
	abstract class LIFECOACH_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class LIFECOACH_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
