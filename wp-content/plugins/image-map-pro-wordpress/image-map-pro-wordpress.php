...
if (!class_exists('ImageMapPro')) {
	class ImageMapPro {
		...
		function register_client_includes() {
			wp_register_style('image-map-pro-frontend-squares-css', plugins_url('/css/squares.css', __FILE__), false, '1.0', false);
			wp_register_style('image-map-pro-frontend-wordpress-css', plugins_url('/css/image-map-pro.css', __FILE__), false, '3.0', false);
			wp_register_script('image-map-pro-frontend-wordpress-js', plugins_url('/js/image-map-pro.js', __FILE__), array('jquery'), '3.0', true);
		}
		function shortcodes() {
